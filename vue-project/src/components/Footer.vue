<template>
    <footer class="p-28 bg-dark d-flex justify-content-lg-center align-content-center">
        <section class="d-flex gap-20 align-self-center">
            <div>
                <p class="text-warning">Discovery</p>
                <ul class="p-0 mx-0">
                    <li class="list-unstyled my-2"><a href="" class="text-decoration-none text-light">New season</a></li>
                    <li class="list-unstyled my-2"><a href="" class="text-decoration-none text-light">Most searched</a></li>
                    <li class="list-unstyled my-2"><a href="" class="text-decoration-none text-light">Most selled</a></li>
                </ul>
            </div>
            <div>
                <p class="text-warning">Discovery</p>
        ...
        <div class="bg-light w-px mx-20"></div>

        <section>
            <span id="logo" class="d-flex gap-2 align-content-middle mb-2">
                <span id="logo-svg">
                ...
                <h3 class="poppins fs-1 text-primary">Penpal</h3>
            </span>
            <p class="text-light w-75">All you need for your home and office.</p>
            <small class="d-flex justify-content-md-end flex-row text-right text-light lh-lg">made by CerescuM<br>©Penpal All Rights Reserved.</small>
        </section>
    </footer>
</template>
...
<style>
    ...
    .bg-warning{
        background-color: #E4C89C !important;
    }
    .text-dark{
