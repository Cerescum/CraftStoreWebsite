<template>
    <section class="d-flex gap-20 my-40 justify-content-center">
        <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fimages.creativemarket.com%2F0.1.0%2Fps%2F1548027%2F3000%2F1987%2Fm1%2Ffpnw%2Fwm0%2Fstylish-stationery-set-.jpg%3F1470935756%26s%3D043442b66a5f63c18bc89f8ffe7de677&f=1&nofb=1&ipt=d5b41660010cc72cdb61d9fc99bc496d0cbb511777255a2d12fbc6b876657c43&ipo=images" alt="" class="w-1/3">
        ...
        <div class="w-1/3">
            ...
            <div class="d-flex justify-content-between gap-16">
                <div>
                    <h4 class="d-flex">$ <span>9.99</span></h4>
                    <div>
                        <p>Quantity</p>
                        <span class="d-flex align-items-middle gap-2 p-1 border-primary">
                ...
                <div>
                    <form action="">
                        ...
                        <input type="radio" name="purchase" id="subscribe"> <label for="subscribe">Subscribe and delivery every month </label> <br>
                        <small>Subscribe now and get the 10% of discount on every recurring order.</small><br>
                        <button class="p-2 rounded-sm bg-primary text-light w-100 d-flex justify-content-center mt-4 align-items-middle">
  ...
  <defs>
    <clipPath id="clip0_982_323">
      <rect width="24.1379" height="24" fill="white" transform="translate(0.761719)"/>
            ...
            <p class="p-2 border-slate-400">
                <b>Description:</b> O serie de carton fin, fără acizi, prezentat într-o gama largă de culori si cu o suprafață naturală. Este potrivit pentru multe tipuri de lucrări: desen, panouri publicitare, schite, colaj, coperti, meniuri restaurant, etc.
            </p>
        </div>
    </section>
</template>
