<template>
    <Header/>
    <section class="gap-20 my-40 justify-content-center d-xl-flex">
        ...
        <div class="w-1/3">
            ...
            <div class="d-flex justify-content-between gap-16">
                <div>
                    <h4 class="d-flex text-primary mb-4">$ <span>9.99</span></h4>
                    <div>
                ...
                <div>
                    <form action="">
                        ...
                        <button class="p-2 rounded-sm bg-primary w-100 mt-5">
                            <a href="/#/cart" class="no-underline d-flex justify-content-center align-items-middle text-light">
